export const reactSelectStyles = {
    ...
    multiValueLabel: () => "border-darkTeal border-l border-t border-b px-2 rounded-tl-md rounded-bl-md p-1",
    multiValue: () => "p-1",
    multiValueRemove: () => "text-lightTeal border-r border-t border-b rounded-tr-md rounded-br-md hover:bg-darkTeal hover:bg-opacity-50 p-1 border-darkTeal"
};