...
const ProjectGallery = () => {
    ...
    const project = useProjectStore((state) => state.project) ||
        (localStorage.getItem('projectInfo') ? JSON.parse(localStorage.getItem('projectInfo')!) : null);
    ...
    const { data: projectImages, error, refetch, isLoading } = useQuery<ProjectImages>({
